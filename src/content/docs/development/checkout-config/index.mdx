...
- [Ajustes finales B2B](/development/frontend/b2b/final-adjustment)

## Checklist final

- [ ] API clients creados con los scopes requeridos.
- [ ] Connectors y Checkout instalados en la organización/proyecto.
- [ ] Payment methods activos y probados en entorno de test.
